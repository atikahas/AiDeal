    ...
    <div class="flex flex-col gap-6 rounded-lg border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <div class="flex items-center gap-3">
            <button
                ...
                wire:target="generateMarketingCopy"
            >
                <span>{{ __('Generate Copy') }}</span>
                <svg wire:loading wire:target="generateMarketingCopy" class="h-4 w-4 animate-spin" viewBox="0 0 24 24" fill="none">
